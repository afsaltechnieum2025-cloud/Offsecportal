        ...
        <div>
          ...
          <YellowAccentBlock>
            <div className="flex items-center justify-between gap-3 mb-2">
              <span className="text-sm font-medium text-orange-100/90">Completion</span>
              <span className="text-sm font-bold text-yellow-300 tabular-nums">
                {pctAll}% <span className="text-orange-100/70 font-medium">({doneAll}/{totalAll})</span>
              </span>
            </div>
                  ...
                  <div className="flex items-center justify-between w-full gap-3 pr-2">
                    <div className="flex items-center gap-2 min-w-0 text-left">
                      ...
                      {complete && (
                        <Badge
                          variant="outline"
                          className="text-[10px] shrink-0 border-yellow-500/40 bg-yellow-500/10 text-yellow-300 uppercase tracking-wide"
                        >
                          Complete
                        </Badge>
                      )}
